...
# ask the candiate a forth qustion
...
# ask the candidate fifth qustion
travel = input("What's your favorite way to travel?\n(A) Driving \n(B) Flying\n")
if travel =="A":
    print("Driving, nica choice!")
elif travel =="B":
    print("Flying? Sounds fun!")
else:
    print("You must tyoe A or B, let's just say your favorite way to travel is by driving")
    travel ="A"
...
kai_like = 0
indy_like = 0
# update scoring variables based on the actibity choice
if activity == "A":
    sam_like == sam_like + 2
...
if sam_like >= 3:
    ...
    print("You're most like Inquistive Indy!")